...
pub struct Column {
    ...
    pub column: String,
    /// Maximum display length in bytes reported through ColumnDefinition41.
    pub column_length: u32,
    /// MySQL character-set/collation identifier reported through
    /// ColumnDefinition41 (63 is the binary character set).
    ...
    /// Fractional scale for DECIMAL and temporal columns.
    pub decimals: u8,
}
...
pub use crate::value::{ToMysqlValue, Value, ValueInner, decode::to_naive_datetime};
