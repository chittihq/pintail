...
Measured 2026-09-11T21:59:12.574Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150037 sync_runs rows for db_963afe49e9898254c97e192ec9d52234 |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4921 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4921 requests: p50 1ms p99 9ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 1ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 4848 vs source 4848 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_963afe49e9898254c97e192ec9d52234","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-11T21:50:49.491071494+00:00","updated_at":"2026-09-11T21:57:18.137210614+00:00"},"tables":30,"rows":8761} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 82 ok, dashboards 75 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 141ms p99 703ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 17ms over 6 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 126MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 60MB before, peak 258MB during (margin 768MB) |
...
| orm-compat | 1.9 | 0.0 | 2.2 |
| crud | 0.0 | 1.9 | 1.9 |
| composite-keys | 0.0 | 0.6 | 2.0 |
| type-edges | 0.0 | 0.6 | 1.9 |
| ddl | 5.7 | 3.7 | 2.0 |
| schema-drift-minimal | 0.0 | 1.9 | 2.0 |
| schema-drift-unseen | 0.0 | 0.6 | 2.0 |
| churn | 0.4 | 2.4 | 1.7 |
| contention | 13.9 | 0.1 | 2.2 |
| execution-budget | 0.0 | 0.1 | 2.3 |
| spill | 4.4 | 0.2 | 2.0 |
| pooling | 0.1 | 2.6 | 1.9 |
| local-database | 0.0 | 0.1 | 2.0 |
| restart | 0.5 | 2.6 | 2.2 |
| activity-history | 0.9 | 0.2 | 2.2 |
| poll-storm | 22.4 | 0.1 | 2.2 |
| control-plane | 33.3 | 0.1 | 1.7 |
| snapshot-ddl-window | 5.2 | 0.1 | 1.7 |
| drop-table-cdc | 8.4 | 0.1 | 1.9 |
| drop-table-recreate | 130.3 | 0.1 | 2.1 |
| drop-table-polling | 105.6 | 0.1 | 1.8 |
| restart-during-snapshot | 4.0 | 0.1 | 1.9 |
| restart-during-resync | 5.0 | 0.1 | 1.8 |
| memory-pressure | 15.3 | 0.1 | 1.9 |
| reconcile-memory | 59.1 | 0.1 | 2.3 |
| drop-database | 11.3 | 0.1 | 2.0 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.8 |
| total | 427.6 | 18.9 | 55.5 |
