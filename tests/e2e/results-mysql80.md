...
Measured 2026-09-12T15:45:09.837Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150037 sync_runs rows for db_e9feea340dc829faee0d6babb6d1c21c |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4907 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4907 requests: p50 1ms p99 12ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 3ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 4653 vs source 4653 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_e9feea340dc829faee0d6babb6d1c21c","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-12T15:36:50.088149983+00:00","updated_at":"2026-09-12T15:43:16.088955319+00:00"},"tables":30,"rows":8566} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 79 ok, dashboards 144 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 258ms p99 1125ms over 240 queries |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 59MB before, peak 226MB during (margin 768MB) |
...
| ddl | 5.9 | 3.4 | 1.8 |
| schema-drift-minimal | 0.0 | 2.1 | 1.6 |
| schema-drift-unseen | 0.1 | 1.1 | 1.7 |
| churn | 0.4 | 2.6 | 1.6 |
...
| poll-storm | 22.6 | 0.1 | 2.1 |
| control-plane | 33.5 | 0.1 | 1.7 |
| snapshot-ddl-window | 5.2 | 0.1 | 1.7 |
| drop-table-cdc | 8.1 | 0.1 | 2.3 |
| drop-table-recreate | 129.8 | 0.1 | 2.0 |
| drop-table-polling | 103.3 | 0.1 | 1.9 |
| restart-during-snapshot | 3.7 | 0.1 | 1.7 |
| restart-during-resync | 5.0 | 0.1 | 1.8 |
| memory-pressure | 15.1 | 0.1 | 1.7 |
| reconcile-memory | 58.3 | 0.1 | 1.8 |
| drop-database | 12.7 | 0.1 | 1.8 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.9 |
| total | 425.5 | 19.8 | 53.3 |
