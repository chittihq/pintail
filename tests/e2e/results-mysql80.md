...
Measured 2026-09-25T14:55:59.450Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150030 sync_runs rows for db_557d2c2e4e344c67e107a27e836f3b2f |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4930 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4930 requests: p50 1ms p99 9ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 1ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 6978 vs source 6978 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_557d2c2e4e344c67e107a27e836f3b2f","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-25T14:50:38.331233969+00:00","updated_at":"2026-09-25T14:54:44.298832040+00:00"},"tables":30,"rows":10891} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 83 ok, dashboards 136 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 264ms p99 1237ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 16ms over 10 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 136MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 64MB before, peak 215MB during (margin 768MB) |
...
| control-plane | 31.0 | 0.1 | 1.3 |
| snapshot-ddl-window | 5.1 | 0.1 | 0.8 |
| drop-table-cdc | 9.4 | 0.1 | 1.3 |
| drop-table-recreate | 11.2 | 0.1 | 1.3 |
| drop-table-polling | 104.2 | 0.1 | 0.8 |
| restart-during-snapshot | 2.6 | 0.1 | 0.9 |
| restart-during-resync | 3.9 | 0.1 | 0.8 |
| memory-pressure | 11.0 | 0.1 | 0.8 |
| reconcile-memory | 33.3 | 0.1 | 0.9 |
| drop-database | 12.1 | 0.1 | 0.8 |
| ddl-documented-gaps | 0.0 | 0.1 | 0.8 |
| total | 273.3 | 17.8 | 29.0 |
