...
Measured 2026-09-10T06:12:40.280Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150028 sync_runs rows for db_3907f822e792d3faed7b612b256bc6dc |
...
| activity-history | activity-history:25 concurrent feed reads do not pile up | PASS | p50 27ms p99 40ms |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4917 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4917 requests: p50 1ms p99 9ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 10ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 6930 vs source 6930 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_3907f822e792d3faed7b612b256bc6dc","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-10T06:05:34.330413991+00:00","updated_at":"2026-09-10T06:11:30.862175391+00:00"},"tables":21,"rows":9655} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 97 ok, dashboards 113 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 214ms p99 1103ms over 240 queries |
...
| orm-compat | 2.4 | 0.0 | 0.1 |
| crud | 0.0 | 0.6 | 0.1 |
| composite-keys | 0.0 | 2.1 | 0.1 |
...
| memory-pressure | 11.1 | 0.1 | 0.4 |
| reconcile-memory | 31.5 | 0.1 | 0.4 |
| drop-database | 12.0 | 0.1 | 0.4 |
| ddl-documented-gaps | 0.0 | 0.1 | 0.4 |
| total | 391.7 | 20.3 | 12.8 |
