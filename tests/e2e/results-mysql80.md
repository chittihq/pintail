...
Measured 2026-09-13T07:21:37.009Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150038 sync_runs rows for db_cb45bba81f7bbd97590d4eff422ce4f7 |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 4893 vs source 4893 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_cb45bba81f7bbd97590d4eff422ce4f7","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-13T07:13:15.442498377+00:00","updated_at":"2026-09-13T07:19:43.463772218+00:00"},"tables":30,"rows":8806} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 82 ok, dashboards 138 ok; no errors |
| memory-pressure | memory-pressure:every failure is a designed refusal | PASS | only refusals; 0 dashboard requests failed |
| memory-pressure | memory-pressure:work still gets done | PASS | wire 240 of 240, http 82 |
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 265ms p99 1275ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 21ms over 10 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 137MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 62MB before, peak 236MB during (margin 768MB) |
...
|---|---|---|---|
| snapshot | 0.0 | 0.1 | 1.8 |
| orm-compat | 1.9 | 0.0 | 2.0 |
| crud | 0.0 | 2.2 | 2.4 |
| composite-keys | 0.0 | 2.6 | 1.9 |
| type-edges | 0.0 | 0.6 | 1.9 |
| ddl | 5.7 | 3.7 | 1.7 |
| schema-drift-minimal | 0.0 | 2.1 | 1.9 |
| schema-drift-unseen | 0.1 | 0.8 | 2.1 |
| churn | 0.5 | 2.1 | 1.5 |
| contention | 13.7 | 0.1 | 2.1 |
| execution-budget | 0.0 | 0.1 | 2.4 |
| spill | 4.5 | 0.2 | 2.0 |
| pooling | 0.1 | 2.3 | 1.9 |
| local-database | 0.0 | 0.1 | 2.1 |
| restart | 0.5 | 2.5 | 2.1 |
| activity-history | 1.0 | 0.2 | 2.3 |
| poll-storm | 22.2 | 0.1 | 2.1 |
| control-plane | 31.2 | 0.1 | 1.8 |
| snapshot-ddl-window | 5.2 | 0.1 | 1.8 |
| drop-table-cdc | 10.3 | 0.1 | 2.0 |
| drop-table-recreate | 130.0 | 0.1 | 2.1 |
| drop-table-polling | 103.3 | 0.1 | 1.8 |
| restart-during-snapshot | 3.8 | 0.1 | 1.9 |
| restart-during-resync | 4.9 | 0.1 | 1.9 |
| memory-pressure | 14.9 | 0.1 | 1.8 |
| reconcile-memory | 58.5 | 0.1 | 1.9 |
| drop-database | 12.3 | 0.1 | 1.8 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.8 |
| total | 424.5 | 21.1 | 54.8 |
