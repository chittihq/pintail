...
Measured 2026-09-11T03:43:56.339Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150030 sync_runs rows for db_8718ad3ba96b4ada2bb1e961bf8cb78e |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 6921 vs source 6921 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_8718ad3ba96b4ada2bb1e961bf8cb78e","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-11T03:36:33.786028955+00:00","updated_at":"2026-09-11T03:42:41.345058079+00:00"},"tables":30,"rows":10834} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 72 ok, dashboards 86 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 173ms p99 622ms over 240 queries |
...
| reconcile-memory | 32.2 | 0.1 | 1.0 |
| drop-database | 12.8 | 0.1 | 1.0 |
| ddl-documented-gaps | 0.0 | 0.1 | 0.9 |
| total | 391.5 | 18.4 | 31.6 |
