...
Measured 2026-09-11T12:20:32.409Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150030 sync_runs rows for db_cfccee57f88d998b523f2796cefe2161 |
...
| poll-storm | poll-storm:latency stays bounded | PASS | 4933 requests: p50 1ms p99 9ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 2ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 6960 vs source 6960 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_cfccee57f88d998b523f2796cefe2161","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-11T12:13:01.877482304+00:00","updated_at":"2026-09-11T12:19:06.827897325+00:00"},"tables":30,"rows":10873} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 239 ok, http 100 ok, dashboards 187 ok; admission-refused×1 |
| memory-pressure | memory-pressure:every failure is a designed refusal | PASS | only refusals; 0 dashboard requests failed |
| memory-pressure | memory-pressure:work still gets done | PASS | wire 239 of 240, http 100 |
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 355ms p99 1645ms over 239 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 29ms over 14 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 198MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation converges the replica on the source | PASS | child 1800000 vs source 1800000 after 6.9s |
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 66MB before, peak 252MB during (margin 768MB) |
...
| orm-compat | 2.4 | 0.0 | 0.8 |
| crud | 0.0 | 1.6 | 0.9 |
| composite-keys | 0.0 | 1.6 | 0.9 |
| type-edges | 0.0 | 1.6 | 1.0 |
| ddl | 6.4 | 2.9 | 0.8 |
| schema-drift-minimal | 0.0 | 1.3 | 0.8 |
| schema-drift-unseen | 0.0 | 1.8 | 0.8 |
| churn | 0.2 | 1.3 | 0.8 |
| contention | 13.2 | 0.1 | 1.6 |
...
| poll-storm | 21.2 | 0.1 | 1.4 |
| control-plane | 30.9 | 0.1 | 0.9 |
| snapshot-ddl-window | 5.1 | 0.1 | 0.9 |
| drop-table-cdc | 9.7 | 0.1 | 1.3 |
| drop-table-recreate | 128.5 | 0.1 | 1.3 |
| drop-table-polling | 103.7 | 0.1 | 0.9 |
| restart-during-snapshot | 2.0 | 0.1 | 0.9 |
| restart-during-resync | 4.1 | 0.2 | 1.6 |
| memory-pressure | 14.3 | 0.2 | 1.7 |
| reconcile-memory | 37.6 | 0.3 | 1.6 |
| drop-database | 10.8 | 0.3 | 1.7 |
| ddl-documented-gaps | 0.0 | 0.3 | 1.5 |
| total | 397.5 | 18.5 | 33.4 |
