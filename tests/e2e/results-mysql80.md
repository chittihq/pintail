...
Measured 2026-09-12T20:59:41.022Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150037 sync_runs rows for db_4a513715e688356ff5ce938a67099147 |
...
| activity-history | activity-history:25 concurrent feed reads do not pile up | PASS | p50 25ms p99 28ms |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4904 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4904 requests: p50 1ms p99 11ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 1ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 4897 vs source 4897 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_4a513715e688356ff5ce938a67099147","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-12T20:51:15.835634172+00:00","updated_at":"2026-09-12T20:57:46.863231235+00:00"},"tables":30,"rows":8810} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 100 ok, dashboards 138 ok; no errors |
| memory-pressure | memory-pressure:every failure is a designed refusal | PASS | only refusals; 0 dashboard requests failed |
| memory-pressure | memory-pressure:work still gets done | PASS | wire 240 of 240, http 100 |
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 252ms p99 1245ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 18ms over 10 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 130MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 59MB before, peak 244MB during (margin 768MB) |
...
| orm-compat | 1.9 | 0.0 | 2.5 |
| crud | 0.0 | 1.4 | 2.0 |
| composite-keys | 0.0 | 0.3 | 1.9 |
| type-edges | 0.0 | 0.6 | 2.0 |
| ddl | 5.9 | 3.4 | 1.6 |
| schema-drift-minimal | 0.0 | 2.4 | 1.9 |
| schema-drift-unseen | 0.1 | 0.6 | 2.0 |
| churn | 0.4 | 2.4 | 1.8 |
| contention | 13.9 | 0.1 | 2.4 |
...
| control-plane | 33.3 | 0.1 | 1.9 |
| snapshot-ddl-window | 5.2 | 0.1 | 2.0 |
| drop-table-cdc | 10.1 | 0.1 | 2.4 |
| drop-table-recreate | 129.8 | 0.1 | 2.3 |
| drop-table-polling | 105.6 | 0.1 | 2.4 |
| restart-during-snapshot | 3.7 | 0.1 | 1.7 |
| restart-during-resync | 4.9 | 0.1 | 2.0 |
| memory-pressure | 14.8 | 0.1 | 2.0 |
| reconcile-memory | 59.0 | 0.1 | 1.7 |
| drop-database | 11.8 | 0.1 | 2.1 |
| ddl-documented-gaps | 0.0 | 0.2 | 1.7 |
| total | 428.9 | 18.3 | 56.9 |
