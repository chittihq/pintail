...
Measured 2026-09-11T13:43:35.381Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150036 sync_runs rows for db_33d72566da2fd020cd579fef48437298 |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 4731 vs source 4731 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_33d72566da2fd020cd579fef48437298","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-11T13:35:15.840728232+00:00","updated_at":"2026-09-11T13:41:44.529646328+00:00"},"tables":30,"rows":8644} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 103 ok, dashboards 96 ok; no errors |
| memory-pressure | memory-pressure:every failure is a designed refusal | PASS | only refusals; 0 dashboard requests failed |
| memory-pressure | memory-pressure:work still gets done | PASS | wire 240 of 240, http 103 |
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 178ms p99 875ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 21ms over 7 samples |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 61MB before, peak 220MB during (margin 768MB) |
...
| orm-compat | 1.9 | 0.0 | 1.9 |
| crud | 0.0 | 2.4 | 2.2 |
| composite-keys | 0.0 | 0.3 | 2.1 |
| type-edges | 0.0 | 0.3 | 2.2 |
| ddl | 5.4 | 3.4 | 1.6 |
| schema-drift-minimal | 0.0 | 2.4 | 1.7 |
| schema-drift-unseen | 0.1 | 0.9 | 1.7 |
| churn | 0.4 | 0.3 | 1.7 |
| contention | 13.8 | 0.1 | 2.1 |
...
| control-plane | 33.5 | 0.1 | 1.8 |
| snapshot-ddl-window | 5.2 | 0.1 | 2.2 |
| drop-table-cdc | 9.9 | 0.1 | 2.1 |
| drop-table-recreate | 130.2 | 0.1 | 2.1 |
| drop-table-polling | 105.3 | 0.1 | 2.2 |
| restart-during-snapshot | 3.7 | 0.1 | 1.6 |
| restart-during-resync | 5.1 | 0.1 | 2.0 |
| memory-pressure | 14.7 | 0.1 | 1.8 |
| reconcile-memory | 56.9 | 0.1 | 1.6 |
| drop-database | 11.5 | 0.1 | 1.8 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.9 |
| total | 426.2 | 17.0 | 55.2 |
