...
Measured 2026-09-11T15:16:14.620Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150037 sync_runs rows for db_159fd2b203b69aaeb6c0349063c1f264 |
...
| poll-storm | poll-storm:latency stays bounded | PASS | 4930 requests: p50 1ms p99 10ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 1ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 4737 vs source 4737 |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 94 ok, dashboards 96 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 179ms p99 892ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 27ms over 7 samples |
...
| reconcile-memory | reconcile-memory:reconciliation converges the replica on the source | PASS | child 1800000 vs source 1800000 after 9.1s |
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 61MB before, peak 264MB during (margin 768MB) |
...
| spill | 4.3 | 0.2 | 1.9 |
| pooling | 0.1 | 2.6 | 2.3 |
| local-database | 0.0 | 0.1 | 2.4 |
| restart | 0.5 | 2.6 | 2.1 |
| activity-history | 1.0 | 0.2 | 2.2 |
| poll-storm | 22.4 | 0.1 | 2.1 |
| control-plane | 33.5 | 0.1 | 2.2 |
| snapshot-ddl-window | 5.2 | 0.1 | 1.8 |
| drop-table-cdc | 10.2 | 0.1 | 2.3 |
| drop-table-recreate | 129.8 | 0.1 | 2.0 |
| drop-table-polling | 13.0 | 0.1 | 2.1 |
| restart-during-snapshot | 3.8 | 0.1 | 1.8 |
| restart-during-resync | 4.9 | 0.1 | 1.9 |
| memory-pressure | 15.4 | 0.1 | 2.0 |
| reconcile-memory | 63.7 | 0.3 | 2.7 |
| drop-database | 10.9 | 0.3 | 2.6 |
| ddl-documented-gaps | 0.1 | 0.4 | 2.7 |
| total | 340.5 | 20.5 | 57.7 |
