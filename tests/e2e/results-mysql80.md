...
Measured 2026-09-10T07:11:38.536Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150028 sync_runs rows for db_e565d6848eba332159193092db568b17 |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4937 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4937 requests: p50 1ms p99 8ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 1ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 7026 vs source 7026 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_e565d6848eba332159193092db568b17","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-10T07:04:32.751057161+00:00","updated_at":"2026-09-10T07:10:29.219738738+00:00"},"tables":21,"rows":9751} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 66 ok, dashboards 102 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 206ms p99 799ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 16ms over 7 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 154MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 59MB before, peak 213MB during (margin 768MB) |
...
| poll-storm | 21.8 | 0.1 | 0.7 |
| control-plane | 31.7 | 0.1 | 0.4 |
| snapshot-ddl-window | 5.0 | 0.1 | 0.4 |
| drop-table-cdc | 8.1 | 0.1 | 0.8 |
| drop-table-recreate | 129.2 | 0.1 | 0.8 |
| drop-table-polling | 104.0 | 0.1 | 0.4 |
| restart-during-snapshot | 2.0 | 0.1 | 0.4 |
| restart-during-resync | 3.8 | 0.1 | 0.5 |
| memory-pressure | 11.0 | 0.1 | 0.4 |
| reconcile-memory | 31.9 | 0.1 | 0.4 |
| drop-database | 11.8 | 0.1 | 0.5 |
| ddl-documented-gaps | 0.0 | 0.1 | 0.4 |
| total | 390.8 | 21.4 | 12.6 |
