...
Measured 2026-09-12T15:19:20.490Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150038 sync_runs rows for db_30b57f891dd54f6e13f203b2d9901723 |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 4854 vs source 4854 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_30b57f891dd54f6e13f203b2d9901723","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-12T15:10:57.682716530+00:00","updated_at":"2026-09-12T15:17:26.125227703+00:00"},"tables":30,"rows":8767} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 83 ok, dashboards 132 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 258ms p99 1372ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 15ms over 9 samples |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 59MB before, peak 257MB during (margin 768MB) |
...
| orm-compat | 1.9 | 0.0 | 1.8 |
| crud | 0.0 | 2.4 | 2.1 |
| composite-keys | 0.0 | 0.3 | 2.0 |
| type-edges | 0.0 | 0.6 | 2.3 |
| ddl | 7.7 | 3.4 | 1.9 |
| schema-drift-minimal | 0.0 | 2.1 | 1.9 |
| schema-drift-unseen | 0.1 | 0.8 | 2.3 |
| churn | 0.4 | 1.8 | 1.9 |
...
| control-plane | 31.3 | 0.1 | 2.3 |
| snapshot-ddl-window | 5.2 | 0.1 | 1.7 |
| drop-table-cdc | 9.9 | 0.1 | 2.3 |
| drop-table-recreate | 129.8 | 0.1 | 1.9 |
| drop-table-polling | 103.3 | 0.1 | 1.7 |
| restart-during-snapshot | 3.8 | 0.1 | 2.0 |
| restart-during-resync | 5.0 | 0.1 | 1.8 |
| memory-pressure | 15.7 | 0.1 | 1.8 |
| reconcile-memory | 59.3 | 0.1 | 2.2 |
| drop-database | 11.3 | 0.1 | 2.0 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.7 |
| total | 427.1 | 18.3 | 56.2 |
