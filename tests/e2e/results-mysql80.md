...
Measured 2026-09-11T00:07:55.192Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150030 sync_runs rows for db_b3969a77529020c7e6fd38aed5deb6a6 |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4916 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4916 requests: p50 1ms p99 10ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 1ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 6926 vs source 6926 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_b3969a77529020c7e6fd38aed5deb6a6","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-11T00:00:34.602680290+00:00","updated_at":"2026-09-11T00:06:40.080480965+00:00"},"tables":30,"rows":10839} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 80 ok, dashboards 84 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 162ms p99 781ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 15ms over 6 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 182MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 62MB before, peak 224MB during (margin 768MB) |
...
| orm-compat | 2.0 | 0.1 | 0.9 |
| crud | 0.0 | 1.9 | 0.9 |
| composite-keys | 0.0 | 1.6 | 1.0 |
| type-edges | 0.0 | 1.3 | 1.0 |
| ddl | 6.6 | 2.9 | 0.9 |
| schema-drift-minimal | 0.0 | 1.1 | 0.9 |
| schema-drift-unseen | 0.0 | 1.9 | 0.8 |
| churn | 0.2 | 1.3 | 0.8 |
| contention | 13.0 | 0.1 | 1.5 |
| execution-budget | 0.0 | 0.1 | 1.5 |
| spill | 5.7 | 0.4 | 1.5 |
| pooling | 0.1 | 0.6 | 1.5 |
| local-database | 0.0 | 0.1 | 1.6 |
| restart | 0.5 | 2.7 | 1.5 |
| activity-history | 1.0 | 0.4 | 1.5 |
| poll-storm | 20.9 | 0.1 | 1.5 |
| control-plane | 31.0 | 0.1 | 1.0 |
| snapshot-ddl-window | 5.1 | 0.1 | 1.0 |
| drop-table-cdc | 9.4 | 0.1 | 1.4 |
| drop-table-recreate | 128.6 | 0.1 | 1.4 |
| drop-table-polling | 103.4 | 0.1 | 1.0 |
| restart-during-snapshot | 2.3 | 0.1 | 1.0 |
| restart-during-resync | 3.9 | 0.1 | 1.0 |
| memory-pressure | 11.0 | 0.1 | 1.0 |
| reconcile-memory | 32.7 | 0.1 | 1.0 |
| drop-database | 12.3 | 0.1 | 1.0 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.0 |
| total | 389.6 | 18.1 | 31.8 |
