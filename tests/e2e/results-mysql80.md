...
Measured 2026-09-11T12:43:23.343Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150031 sync_runs rows for db_45fcf89a8c15910499a238a3af4e9bdb |
...
| activity-history | activity-history:25 concurrent feed reads do not pile up | PASS | p50 32ms p99 35ms |
...
| poll-storm | poll-storm:latency stays bounded | PASS | 4936 requests: p50 1ms p99 7ms |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 69 ok, dashboards 96 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 183ms p99 785ms over 240 queries |
...
| restart | 0.5 | 2.9 | 1.6 |
| activity-history | 1.0 | 0.4 | 1.6 |
| poll-storm | 23.3 | 0.1 | 1.4 |
| control-plane | 31.0 | 0.1 | 0.9 |
| snapshot-ddl-window | 5.1 | 0.1 | 0.9 |
| drop-table-cdc | 9.9 | 0.1 | 1.3 |
| drop-table-recreate | 128.5 | 0.1 | 2.0 |
| drop-table-polling | 13.1 | 0.1 | 0.9 |
| restart-during-snapshot | 2.0 | 0.1 | 0.9 |
| restart-during-resync | 3.8 | 0.1 | 0.9 |
| memory-pressure | 10.8 | 0.1 | 0.9 |
| reconcile-memory | 32.3 | 0.1 | 1.0 |
| drop-database | 12.8 | 0.1 | 0.9 |
| ddl-documented-gaps | 0.0 | 0.1 | 0.8 |
| total | 302.6 | 19.6 | 32.2 |
