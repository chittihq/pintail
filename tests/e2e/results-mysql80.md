...
Measured 2026-09-13T11:15:07.008Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150038 sync_runs rows for db_93493edb02303f3feae0508eb9c5e434 |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 4866 vs source 4866 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_93493edb02303f3feae0508eb9c5e434","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-13T11:06:42.893920090+00:00","updated_at":"2026-09-13T11:13:16.331669485+00:00"},"tables":30,"rows":8779} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 88 ok, dashboards 138 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 277ms p99 1024ms over 240 queries |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 59MB before, peak 247MB during (margin 768MB) |
...
| crud | 0.0 | 2.2 | 2.3 |
| composite-keys | 0.0 | 2.6 | 2.0 |
| type-edges | 0.0 | 0.3 | 1.9 |
| ddl | 5.9 | 3.4 | 1.8 |
| schema-drift-minimal | 0.0 | 2.1 | 1.8 |
| schema-drift-unseen | 0.1 | 0.9 | 2.1 |
| churn | 0.4 | 2.1 | 2.0 |
| contention | 13.9 | 0.1 | 1.8 |
| execution-budget | 0.0 | 0.1 | 2.5 |
| spill | 4.5 | 0.2 | 2.0 |
| pooling | 0.1 | 2.6 | 2.1 |
...
| drop-table-cdc | 9.9 | 0.1 | 2.0 |
| drop-table-recreate | 130.4 | 0.1 | 2.3 |
| drop-table-polling | 105.8 | 0.1 | 1.8 |
| restart-during-snapshot | 3.2 | 0.1 | 1.9 |
| restart-during-resync | 5.0 | 0.1 | 1.8 |
| memory-pressure | 14.8 | 0.1 | 1.6 |
| reconcile-memory | 58.0 | 0.1 | 1.9 |
| drop-database | 10.5 | 0.1 | 1.8 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.8 |
| total | 426.7 | 20.9 | 55.4 |
