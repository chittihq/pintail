...
Measured 2026-09-11T08:11:35.556Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150040 sync_runs rows for db_bd5795e7afd85ed8900107a1fcaa7fbf |
...
| activity-history | activity-history:25 concurrent feed reads do not pile up | PASS | p50 28ms p99 32ms |
...
| poll-storm | poll-storm:latency stays bounded | PASS | 4933 requests: p50 1ms p99 11ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 2ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 4800 vs source 4800 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_bd5795e7afd85ed8900107a1fcaa7fbf","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-11T08:03:05.940216870+00:00","updated_at":"2026-09-11T08:09:44.105998613+00:00"},"tables":30,"rows":8713} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 97 ok, dashboards 96 ok; no errors |
| memory-pressure | memory-pressure:every failure is a designed refusal | PASS | only refusals; 0 dashboard requests failed |
| memory-pressure | memory-pressure:work still gets done | PASS | wire 240 of 240, http 97 |
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 177ms p99 837ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 26ms over 7 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 189MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 60MB before, peak 226MB during (margin 768MB) |
...
|---|---|---|---|
| snapshot | 0.0 | 0.1 | 2.1 |
| orm-compat | 2.2 | 0.0 | 2.1 |
| crud | 0.0 | 1.4 | 2.6 |
| composite-keys | 0.0 | 2.4 | 2.1 |
| type-edges | 0.0 | 0.6 | 2.1 |
| ddl | 5.4 | 3.7 | 1.9 |
| schema-drift-minimal | 0.0 | 1.9 | 1.6 |
| schema-drift-unseen | 0.1 | 1.1 | 2.1 |
| churn | 0.4 | 2.1 | 1.8 |
| contention | 13.5 | 0.1 | 2.7 |
| execution-budget | 0.0 | 0.2 | 4.6 |
| spill | 6.4 | 0.6 | 2.7 |
| pooling | 0.1 | 1.3 | 2.0 |
| local-database | 0.0 | 0.1 | 2.0 |
| restart | 0.5 | 2.4 | 2.3 |
| activity-history | 1.0 | 0.2 | 2.5 |
| poll-storm | 22.1 | 0.1 | 2.5 |
| control-plane | 33.1 | 0.1 | 2.1 |
| snapshot-ddl-window | 5.2 | 0.1 | 2.1 |
| drop-table-cdc | 9.6 | 0.2 | 2.2 |
| drop-table-recreate | 130.2 | 0.1 | 2.1 |
| drop-table-polling | 105.2 | 0.1 | 1.8 |
| restart-during-snapshot | 3.5 | 0.2 | 2.2 |
| restart-during-resync | 4.8 | 0.1 | 2.0 |
| memory-pressure | 15.0 | 0.1 | 1.9 |
| reconcile-memory | 57.2 | 0.1 | 2.0 |
| drop-database | 11.0 | 0.1 | 2.0 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.7 |
| total | 426.7 | 20.0 | 61.8 |
