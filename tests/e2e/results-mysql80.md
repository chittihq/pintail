...
Measured 2026-09-11T10:35:40.607Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150036 sync_runs rows for db_b5f14d46bd21a5f1d241b9d5ee8812a3 |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 4729 vs source 4729 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_b5f14d46bd21a5f1d241b9d5ee8812a3","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-11T10:27:17.736790877+00:00","updated_at":"2026-09-11T10:33:46.739279886+00:00"},"tables":30,"rows":8642} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 84 ok, dashboards 90 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 165ms p99 785ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 15ms over 6 samples |
...
| crud | 0.0 | 2.2 | 1.8 |
| composite-keys | 0.0 | 0.8 | 1.9 |
| type-edges | 0.0 | 0.6 | 2.2 |
| ddl | 5.4 | 3.4 | 2.1 |
| schema-drift-minimal | 0.0 | 1.9 | 1.7 |
| schema-drift-unseen | 0.1 | 0.9 | 1.6 |
| churn | 0.3 | 0.3 | 1.8 |
...
| poll-storm | 22.3 | 0.1 | 2.3 |
| control-plane | 33.3 | 0.1 | 2.2 |
| snapshot-ddl-window | 5.2 | 0.1 | 2.1 |
| drop-table-cdc | 9.8 | 0.1 | 2.2 |
| drop-table-recreate | 130.0 | 0.1 | 2.3 |
| drop-table-polling | 105.3 | 0.1 | 2.0 |
| restart-during-snapshot | 3.5 | 0.1 | 2.0 |
| restart-during-resync | 5.0 | 0.1 | 1.8 |
| memory-pressure | 15.2 | 0.1 | 1.8 |
| reconcile-memory | 58.5 | 0.1 | 2.1 |
| drop-database | 12.0 | 0.1 | 1.8 |
| ddl-documented-gaps | 0.0 | 0.1 | 2.0 |
| total | 427.7 | 16.9 | 57.2 |
