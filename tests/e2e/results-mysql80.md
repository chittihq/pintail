...
Measured 2026-09-12T11:38:28.890Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150035 sync_runs rows for db_ca68b792a97b516b959f54a7ebf39eb8 |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 4722 vs source 4722 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_ca68b792a97b516b959f54a7ebf39eb8","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-12T11:30:06.249130012+00:00","updated_at":"2026-09-12T11:36:33.837853393+00:00"},"tables":30,"rows":8635} |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 263ms p99 1228ms over 240 queries |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 62MB before, peak 238MB during (margin 768MB) |
...
| crud | 0.0 | 1.9 | 1.9 |
| composite-keys | 0.0 | 0.6 | 1.7 |
| type-edges | 0.0 | 0.8 | 2.1 |
| ddl | 5.7 | 3.5 | 1.6 |
...
| restart | 0.5 | 2.6 | 2.1 |
| activity-history | 1.0 | 0.2 | 2.0 |
| poll-storm | 22.7 | 0.1 | 2.1 |
| control-plane | 33.2 | 0.1 | 2.0 |
| snapshot-ddl-window | 5.3 | 0.1 | 2.0 |
| drop-table-cdc | 9.9 | 0.1 | 2.3 |
| drop-table-recreate | 130.0 | 0.1 | 2.1 |
| drop-table-polling | 106.0 | 0.1 | 2.2 |
| restart-during-snapshot | 3.5 | 0.1 | 2.1 |
| restart-during-resync | 5.2 | 0.1 | 1.8 |
| memory-pressure | 14.9 | 0.1 | 2.0 |
| reconcile-memory | 58.8 | 0.1 | 1.7 |
| drop-database | 12.0 | 0.1 | 2.2 |
| ddl-documented-gaps | 0.0 | 0.2 | 2.0 |
| total | 429.1 | 17.6 | 54.9 |
