...
Measured 2026-09-11T12:13:11.858Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150035 sync_runs rows for db_6322a08392f2768db51d2edd1b522687 |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 4849 vs source 4849 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_6322a08392f2768db51d2edd1b522687","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-11T12:04:37.139134639+00:00","updated_at":"2026-09-11T12:11:05.642837144+00:00"},"tables":30,"rows":8762} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 239 ok, http 78 ok, dashboards 208 ok; admission-refused×3 |
| memory-pressure | memory-pressure:every failure is a designed refusal | PASS | only refusals; 0 dashboard requests failed |
| memory-pressure | memory-pressure:work still gets done | PASS | wire 239 of 240, http 78 |
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 418ms p99 1858ms over 239 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 35ms over 15 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 187MB with a 256MB budget |
| memory-pressure | memory-pressure:the replica catches up after the storm | PASS | big 201500 vs source 201500 |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 58MB before, peak 245MB during (margin 768MB) |
...
|---|---|---|---|
| snapshot | 0.0 | 0.1 | 2.0 |
| orm-compat | 2.1 | 0.0 | 2.0 |
| crud | 0.0 | 1.7 | 1.9 |
| composite-keys | 0.0 | 0.6 | 2.0 |
| type-edges | 0.0 | 0.6 | 2.2 |
| ddl | 5.4 | 3.5 | 1.8 |
| schema-drift-minimal | 0.0 | 2.4 | 1.8 |
| schema-drift-unseen | 0.1 | 0.6 | 1.7 |
| churn | 0.4 | 0.3 | 1.6 |
| contention | 13.7 | 0.1 | 2.2 |
| execution-budget | 0.0 | 0.1 | 2.1 |
| spill | 4.4 | 0.2 | 2.3 |
| pooling | 0.1 | 2.4 | 1.9 |
| local-database | 0.0 | 0.1 | 2.1 |
| restart | 0.5 | 2.6 | 2.1 |
| activity-history | 1.0 | 0.2 | 2.2 |
| poll-storm | 22.4 | 0.1 | 2.3 |
| control-plane | 33.2 | 0.1 | 2.0 |
| snapshot-ddl-window | 5.2 | 0.1 | 1.7 |
| drop-table-cdc | 10.2 | 0.1 | 2.2 |
| drop-table-recreate | 130.2 | 0.4 | 3.2 |
| drop-table-polling | 104.6 | 0.3 | 2.6 |
| restart-during-snapshot | 4.1 | 0.4 | 2.6 |
| restart-during-resync | 6.2 | 0.3 | 2.9 |
| memory-pressure | 19.4 | 0.4 | 3.2 |
| reconcile-memory | 59.3 | 0.1 | 2.0 |
| drop-database | 12.3 | 0.1 | 2.0 |
| ddl-documented-gaps | 0.0 | 0.1 | 2.3 |
| total | 434.7 | 17.9 | 60.9 |
