...
Measured 2026-09-11T06:20:39.800Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150030 sync_runs rows for db_0901674d4382d5c12951971b6e838b8b |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4936 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4936 requests: p50 1ms p99 10ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 2ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 6969 vs source 6969 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_0901674d4382d5c12951971b6e838b8b","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-11T06:13:22.779809902+00:00","updated_at":"2026-09-11T06:19:27.775595373+00:00"},"tables":30,"rows":10882} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 88 ok, dashboards 89 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 161ms p99 729ms over 240 queries |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 62MB before, peak 227MB during (margin 768MB) |
...
| drop-table-recreate | 128.3 | 0.1 | 1.4 |
| drop-table-polling | 103.6 | 0.1 | 1.0 |
| restart-during-snapshot | 2.0 | 0.1 | 1.0 |
| restart-during-resync | 3.8 | 0.1 | 1.0 |
| memory-pressure | 10.7 | 0.1 | 1.0 |
| reconcile-memory | 31.7 | 0.1 | 1.0 |
| drop-database | 10.8 | 0.1 | 1.0 |
| ddl-documented-gaps | 0.0 | 0.1 | 0.9 |
| total | 386.2 | 18.3 | 31.4 |
