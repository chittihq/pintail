...
Measured 2026-09-12T10:12:27.891Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150037 sync_runs rows for db_4697bbce2bb6de17a332b756654d54fa |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 4794 vs source 4794 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_4697bbce2bb6de17a332b756654d54fa","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-12T10:04:07.482736203+00:00","updated_at":"2026-09-12T10:10:35.823089316+00:00"},"tables":30,"rows":8707} |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 264ms p99 1121ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 26ms over 10 samples |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 59MB before, peak 259MB during (margin 768MB) |
...
| crud | 0.0 | 2.2 | 1.9 |
| composite-keys | 0.0 | 0.6 | 2.3 |
| type-edges | 0.0 | 0.3 | 2.1 |
| ddl | 5.4 | 3.7 | 1.6 |
| schema-drift-minimal | 0.0 | 2.4 | 1.7 |
| schema-drift-unseen | 0.1 | 0.8 | 1.7 |
| churn | 0.3 | 2.6 | 2.0 |
...
| poll-storm | 22.5 | 0.1 | 1.9 |
| control-plane | 31.2 | 0.1 | 2.2 |
| snapshot-ddl-window | 5.2 | 0.1 | 2.2 |
| drop-table-cdc | 9.6 | 0.1 | 2.2 |
| drop-table-recreate | 130.0 | 0.1 | 2.3 |
| drop-table-polling | 105.3 | 0.1 | 1.7 |
| restart-during-snapshot | 3.3 | 0.1 | 1.9 |
| restart-during-resync | 5.0 | 0.1 | 2.2 |
| memory-pressure | 15.9 | 0.1 | 1.8 |
| reconcile-memory | 56.8 | 0.1 | 2.0 |
| drop-database | 11.5 | 0.1 | 1.8 |
| ddl-documented-gaps | 0.0 | 0.1 | 2.1 |
| total | 423.8 | 19.5 | 56.0 |
