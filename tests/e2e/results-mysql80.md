...
Measured 2026-09-10T20:19:54.227Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150030 sync_runs rows for db_7fe4c772c885d7c1ba2053431bb4d496 |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 6976 vs source 6976 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_7fe4c772c885d7c1ba2053431bb4d496","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-10T20:12:34.238304567+00:00","updated_at":"2026-09-10T20:18:39.405689349+00:00"},"tables":30,"rows":10889} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 78 ok, dashboards 90 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 173ms p99 851ms over 240 queries |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 63MB before, peak 223MB during (margin 768MB) |
...
| ddl | 6.6 | 2.7 | 0.9 |
| schema-drift-minimal | 0.0 | 1.4 | 0.8 |
| schema-drift-unseen | 0.0 | 1.6 | 0.9 |
| churn | 0.2 | 1.3 | 0.9 |
| contention | 12.7 | 0.1 | 1.5 |
...
| drop-table-polling | 103.7 | 0.1 | 1.0 |
| restart-during-snapshot | 2.1 | 0.1 | 1.0 |
| restart-during-resync | 3.9 | 0.1 | 1.0 |
| memory-pressure | 11.0 | 0.1 | 1.0 |
| reconcile-memory | 33.0 | 0.1 | 1.0 |
| drop-database | 11.8 | 0.1 | 1.0 |
| ddl-documented-gaps | 0.0 | 0.1 | 0.9 |
| total | 389.0 | 18.1 | 31.8 |
