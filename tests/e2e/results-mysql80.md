...
Measured 2026-09-11T04:57:54.728Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150030 sync_runs rows for db_da36f05924be9c1773cec44c1532e02e |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4939 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4939 requests: p50 1ms p99 7ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 1ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 6949 vs source 6949 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_da36f05924be9c1773cec44c1532e02e","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-11T04:50:37.124365936+00:00","updated_at":"2026-09-11T04:56:42.496652078+00:00"},"tables":30,"rows":10862} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 87 ok, dashboards 96 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 179ms p99 759ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 15ms over 7 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 175MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 62MB before, peak 212MB during (margin 768MB) |
