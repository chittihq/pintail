...
Measured 2026-09-10T10:23:12.295Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150030 sync_runs rows for db_67777bfc3e1bf5525443488192e40c3b |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 6957 vs source 6957 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_67777bfc3e1bf5525443488192e40c3b","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-10T10:15:49.120926982+00:00","updated_at":"2026-09-10T10:21:57.069397163+00:00"},"tables":30,"rows":10870} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 85 ok, dashboards 111 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 202ms p99 1106ms over 240 queries |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 59MB before, peak 215MB during (margin 768MB) |
...
| orm-compat | 1.9 | 0.1 | 0.9 |
| crud | 0.0 | 1.9 | 1.0 |
| composite-keys | 0.0 | 1.6 | 1.0 |
| type-edges | 0.0 | 1.3 | 1.0 |
| ddl | 6.6 | 2.9 | 0.9 |
| schema-drift-minimal | 0.0 | 1.1 | 0.8 |
| schema-drift-unseen | 0.0 | 1.8 | 0.9 |
| churn | 0.2 | 1.1 | 1.0 |
...
| control-plane | 33.0 | 0.1 | 1.0 |
| snapshot-ddl-window | 5.1 | 0.1 | 1.0 |
| drop-table-cdc | 9.4 | 0.1 | 1.5 |
| drop-table-recreate | 128.3 | 0.1 | 1.4 |
| drop-table-polling | 103.6 | 0.1 | 1.1 |
| restart-during-snapshot | 2.3 | 0.1 | 1.1 |
| restart-during-resync | 3.9 | 0.1 | 1.0 |
| memory-pressure | 10.9 | 0.1 | 1.0 |
| reconcile-memory | 32.3 | 0.1 | 1.0 |
| drop-database | 12.6 | 0.1 | 1.1 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.0 |
| total | 391.7 | 17.9 | 32.5 |
