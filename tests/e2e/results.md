...
Measured 2026-09-09T18:30:23.206Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150028 sync_runs rows for db_756a1227ad54f49cd41bd6090ff327bf |
...
| poll-storm | poll-storm:latency stays bounded | PASS | 4905 requests: p50 1ms p99 11ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 1ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 7464 vs source 7464 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_756a1227ad54f49cd41bd6090ff327bf","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-09T18:23:27.866639997+00:00","updated_at":"2026-09-09T18:29:25.425378871+00:00"},"tables":21,"rows":10189} |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 203ms p99 1080ms over 240 queries |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 66MB before, peak 183MB during (margin 768MB) |
...
| poll-storm | 21.6 | 0.1 | 0.8 |
| control-plane | 31.5 | 0.1 | 0.5 |
...
| memory-pressure | 9.8 | 0.1 | 0.5 |
| reconcile-memory | 21.2 | 0.1 | 0.5 |
| drop-database | 12.3 | 0.1 | 0.5 |
| ddl-documented-gaps | 0.0 | 0.1 | 0.4 |
| total | 379.6 | 21.1 | 13.6 |
