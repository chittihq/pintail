...
Measured 2026-09-11T23:18:43.822Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150034 sync_runs rows for db_60b3ea68043a93a838cdd038d221346e |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 5163 vs source 5163 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_60b3ea68043a93a838cdd038d221346e","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-11T23:11:03.084470397+00:00","updated_at":"2026-09-11T23:17:20.420284390+00:00"},"tables":30,"rows":9076} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 93 ok, dashboards 77 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 138ms p99 597ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 18ms over 6 samples |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 58MB before, peak 201MB during (margin 768MB) |
...
| orm-compat | 2.1 | 0.0 | 1.5 |
| crud | 0.0 | 2.7 | 1.4 |
| composite-keys | 0.0 | 1.1 | 1.6 |
| type-edges | 0.0 | 0.8 | 1.6 |
| ddl | 6.2 | 3.4 | 1.3 |
| schema-drift-minimal | 0.0 | 2.6 | 1.2 |
...
| control-plane | 31.4 | 0.1 | 1.6 |
| snapshot-ddl-window | 5.2 | 0.1 | 1.5 |
| drop-table-cdc | 8.4 | 0.1 | 1.8 |
| drop-table-recreate | 127.8 | 0.1 | 2.0 |
| drop-table-polling | 103.1 | 0.1 | 1.4 |
| restart-during-snapshot | 2.8 | 0.1 | 1.7 |
| restart-during-resync | 4.4 | 0.1 | 1.6 |
| memory-pressure | 12.9 | 0.1 | 1.7 |
| reconcile-memory | 34.4 | 0.1 | 1.5 |
| drop-database | 12.0 | 0.1 | 1.5 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.7 |
| total | 393.8 | 19.9 | 45.9 |
