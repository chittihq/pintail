...
Measured 2026-09-12T19:04:02.602Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150032 sync_runs rows for db_f3ee333a7fa96619d823f828debac1b6 |
...
| activity-history | activity-history:25 concurrent feed reads do not pile up | PASS | p50 24ms p99 28ms |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 5133 vs source 5133 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_f3ee333a7fa96619d823f828debac1b6","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-12T18:56:27.335571559+00:00","updated_at":"2026-09-12T19:02:38.427155867+00:00"},"tables":30,"rows":9046} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 85 ok, dashboards 138 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 269ms p99 1176ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 17ms over 10 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 133MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 59MB before, peak 196MB during (margin 768MB) |
...
| type-edges | 0.0 | 1.1 | 1.9 |
| ddl | 5.7 | 3.4 | 1.4 |
| schema-drift-minimal | 0.0 | 2.6 | 1.3 |
| schema-drift-unseen | 0.0 | 1.3 | 1.6 |
| churn | 0.3 | 0.3 | 1.3 |
| contention | 14.1 | 0.1 | 1.7 |
...
| drop-table-cdc | 8.4 | 0.1 | 1.8 |
| drop-table-recreate | 127.9 | 0.1 | 1.8 |
| drop-table-polling | 103.2 | 0.1 | 1.4 |
| restart-during-snapshot | 2.8 | 0.1 | 1.4 |
| restart-during-resync | 4.5 | 0.1 | 1.4 |
| memory-pressure | 13.6 | 0.1 | 1.5 |
| reconcile-memory | 34.5 | 0.1 | 1.7 |
| drop-database | 12.0 | 0.1 | 1.8 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.5 |
| total | 394.5 | 14.6 | 45.0 |
