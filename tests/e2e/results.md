...
Measured 2026-09-05T21:12:43.302Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150037 sync_runs rows for db_40a74cbedf17eba2111fea818f5a8499 |
...
| activity-history | activity-history:25 concurrent feed reads do not pile up | PASS | p50 30ms p99 44ms |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4801 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4801 requests: p50 2ms p99 18ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 5ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 831 vs source 831 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"id":"db_40a74cbedf17eba2111fea818f5a8499","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-05T21:02:55.792729+00:00","updated_at":"2026-09-05T21:10:41.550259+00:00"},"tables":18,"rows":1339} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 66 ok, dashboards 186 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 426ms p99 1420ms over 240 queries |
...
| reconcile-memory | reconcile-memory:reconciliation converges the replica on the source | PASS | child 1800000 vs source 1800000 after 15.9s |
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 27MB before, peak 153MB during (margin 768MB) |
...
| orm-compat | 10.7 | 0.4 | 0.7 |
| crud | 0.2 | 2.7 | 0.9 |
| type-edges | 0.0 | 1.5 | 1.0 |
| ddl | 8.6 | 12.6 | 0.7 |
| schema-drift-minimal | 0.2 | 3.6 | 0.6 |
| schema-drift-unseen | 0.9 | 5.5 | 0.6 |
| churn | 10.8 | 2.4 | 0.8 |
| contention | 14.5 | 0.2 | 0.7 |
| execution-budget | 0.0 | 0.1 | 0.6 |
| spill | 3.0 | 0.2 | 0.5 |
| pooling | 0.1 | 1.4 | 0.8 |
| local-database | 0.0 | 0.5 | 0.5 |
| restart | 0.5 | 3.4 | 0.7 |
| activity-history | 1.5 | 0.6 | 0.7 |
| poll-storm | 28.3 | 0.5 | 0.6 |
| control-plane | 53.8 | 1.1 | 0.9 |
| snapshot-ddl-window | 7.0 | 0.9 | 0.6 |
| drop-table-cdc | 16.9 | 0.9 | 0.8 |
| drop-table-recreate | 137.7 | 0.7 | 0.8 |
| drop-table-polling | 126.4 | 1.3 | 1.6 |
| restart-during-snapshot | 7.5 | 1.3 | 1.0 |
| restart-during-resync | 7.9 | 0.9 | 0.8 |
| memory-pressure | 14.3 | 1.4 | 0.9 |
| reconcile-memory | 44.9 | 1.3 | 1.0 |
| drop-database | 16.8 | 1.3 | 0.7 |
| ddl-documented-gaps | 0.0 | 1.2 | 0.8 |
| total | 512.6 | 48.9 | 21.1 |
