...
Measured 2026-09-08T19:53:13.074Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150028 sync_runs rows for db_cb1198c2b8898d5cb3e7a44414e00e79 |
...
| activity-history | activity-history:25 concurrent feed reads do not pile up | PASS | p50 28ms p99 46ms |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 7470 vs source 7470 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_cb1198c2b8898d5cb3e7a44414e00e79","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-08T19:46:17.932380459+00:00","updated_at":"2026-09-08T19:52:15.406808547+00:00"},"tables":21,"rows":10195} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 81 ok, dashboards 105 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 212ms p99 1108ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 21ms over 8 samples |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 62MB before, peak 185MB during (margin 768MB) |
...
| drop-table-recreate | 128.9 | 0.1 | 0.8 |
| drop-table-polling | 104.1 | 0.1 | 0.4 |
| restart-during-snapshot | 2.0 | 0.1 | 0.5 |
| restart-during-resync | 3.6 | 0.1 | 0.4 |
| memory-pressure | 9.7 | 0.1 | 0.4 |
| reconcile-memory | 21.3 | 0.1 | 0.4 |
| drop-database | 12.2 | 0.1 | 0.4 |
| ddl-documented-gaps | 0.0 | 0.1 | 0.4 |
| total | 379.4 | 21.6 | 13.0 |
