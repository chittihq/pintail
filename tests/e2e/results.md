...
Measured 2026-09-24T08:06:59.557Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150030 sync_runs rows for db_ce620e695110e1738f5e459d08e74316 |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 7529 vs source 7529 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_ce620e695110e1738f5e459d08e74316","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-24T08:01:53.434500903+00:00","updated_at":"2026-09-24T08:06:00.688241137+00:00"},"tables":30,"rows":11442} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 91 ok, dashboards 150 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 266ms p99 1130ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 27ms over 11 samples |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 61MB before, peak 216MB during (margin 768MB) |
...
| restart-during-snapshot | 1.8 | 0.1 | 0.7 |
| restart-during-resync | 3.6 | 0.1 | 0.7 |
| memory-pressure | 9.6 | 0.1 | 0.7 |
| reconcile-memory | 21.2 | 0.1 | 0.7 |
| drop-database | 11.8 | 0.1 | 0.7 |
| ddl-documented-gaps | 0.0 | 0.1 | 0.6 |
| total | 261.1 | 18.9 | 25.1 |
