...
Measured 2026-09-12T15:36:39.112Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150033 sync_runs rows for db_b326bcf77a87a089a2dbe5e02c901c43 |
...
| activity-history | activity-history:25 concurrent feed reads do not pile up | PASS | p50 28ms p99 30ms |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 5271 vs source 5271 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_b326bcf77a87a089a2dbe5e02c901c43","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-12T15:28:54.462989804+00:00","updated_at":"2026-09-12T15:35:11.860476704+00:00"},"tables":30,"rows":9184} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 76 ok, dashboards 131 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 276ms p99 1110ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 13ms over 9 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 128MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 59MB before, peak 260MB during (margin 768MB) |
...
| schema-drift-unseen | 0.0 | 1.1 | 1.5 |
| churn | 0.3 | 0.3 | 1.3 |
...
| drop-table-cdc | 8.6 | 0.1 | 1.8 |
| drop-table-recreate | 128.0 | 0.1 | 2.0 |
| drop-table-polling | 106.0 | 0.1 | 1.4 |
| restart-during-snapshot | 2.6 | 0.1 | 1.7 |
| restart-during-resync | 4.7 | 0.1 | 1.8 |
| memory-pressure | 13.1 | 0.1 | 1.6 |
| reconcile-memory | 36.7 | 0.1 | 1.5 |
| drop-database | 12.2 | 0.1 | 1.6 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.8 |
| total | 399.9 | 16.4 | 47.2 |
