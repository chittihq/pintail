...
Measured 2026-09-06T16:37:32.620Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150049 sync_runs rows for db_4c61698c69ea7584cac4b8c56cb3df7b |
| activity-history | activity-history:the feed pages the full history | PASS | limit=200 returned 200 |
| activity-history | activity-history:scoped feed stays fast over a large history | PASS | p50 3ms p95 18ms over 150000 rows |
| activity-history | activity-history:workspace feed stays fast over a large history | PASS | p50 3ms p95 11ms |
| activity-history | activity-history:25 concurrent feed reads do not pile up | PASS | p50 41ms p99 53ms |
| activity-history | activity-history:health answers while the feed is hammered | PASS | health p95 42ms |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4841 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4841 requests: p50 2ms p99 21ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 8ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 651 vs source 651 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"id":"db_4c61698c69ea7584cac4b8c56cb3df7b","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-06T16:19:46.118524+00:00","updated_at":"2026-09-06T16:31:12.998994+00:00"},"tables":18,"rows":1159} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 239 ok, http 74 ok, dashboards 197 ok; admission-refused×1 |
| memory-pressure | memory-pressure:every failure is a designed refusal | PASS | only refusals; 0 dashboard requests failed |
| memory-pressure | memory-pressure:work still gets done | PASS | wire 239 of 240, http 74 |
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 438ms p99 1436ms over 239 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 11ms over 14 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 263MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation converges the replica on the source | PASS | child 1800000 vs source 1800000 after 62.4s |
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 20MB before, peak 175MB during (margin 768MB) |
...
|---|---|---|---|
| snapshot | 0.0 | 1.7 | 1.4 |
| orm-compat | 10.0 | 0.4 | 1.1 |
| crud | 0.7 | 3.1 | 1.1 |
| type-edges | 0.1 | 1.4 | 1.3 |
| ddl | 16.8 | 35.3 | 1.2 |
| schema-drift-minimal | 0.2 | 14.0 | 1.4 |
| schema-drift-unseen | 1.9 | 8.1 | 3.1 |
| churn | 25.9 | 2.6 | 1.3 |
| contention | 14.1 | 0.9 | 1.4 |
| execution-budget | 0.0 | 0.6 | 1.4 |
| spill | 2.9 | 0.6 | 1.7 |
| pooling | 0.1 | 0.6 | 1.4 |
| local-database | 0.1 | 0.4 | 1.3 |
| restart | 0.6 | 2.7 | 2.6 |
| activity-history | 1.7 | 1.1 | 1.6 |
| poll-storm | 33.0 | 0.9 | 1.4 |
| control-plane | 142.3 | 2.6 | 1.8 |
| snapshot-ddl-window | 14.3 | 1.7 | 1.5 |
| drop-table-cdc | 24.6 | 2.1 | 1.4 |
| drop-table-recreate | 140.7 | 2.0 | 2.6 |
| drop-table-polling | 168.2 | 1.8 | 1.4 |
| restart-during-snapshot | 22.0 | 2.2 | 1.5 |
| restart-during-resync | 24.3 | 2.2 | 1.3 |
| memory-pressure | 56.4 | 2.5 | 1.7 |
| reconcile-memory | 192.5 | 3.1 | 1.6 |
| drop-database | 22.0 | 1.8 | 1.2 |
| ddl-documented-gaps | 0.6 | 1.8 | 1.2 |
| total | 916.0 | 98.3 | 42.0 |
