...
Measured 2026-09-11T21:50:39.024Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150033 sync_runs rows for db_646854f179b687c6f2845764a5e660cc |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 5214 vs source 5214 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_646854f179b687c6f2845764a5e660cc","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-11T21:42:57.989166695+00:00","updated_at":"2026-09-11T21:49:15.282607775+00:00"},"tables":30,"rows":9127} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 88 ok, dashboards 78 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 137ms p99 735ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 30ms over 6 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 125MB with a 256MB budget |
...
| orm-compat | 2.2 | 0.0 | 1.7 |
| crud | 0.0 | 2.2 | 1.7 |
| composite-keys | 0.0 | 0.8 | 1.6 |
| type-edges | 0.0 | 1.1 | 1.6 |
| ddl | 5.9 | 3.4 | 1.3 |
| schema-drift-minimal | 0.0 | 0.4 | 1.4 |
...
| poll-storm | 22.7 | 0.1 | 2.0 |
| control-plane | 31.3 | 0.1 | 1.4 |
| snapshot-ddl-window | 5.2 | 0.1 | 1.9 |
| drop-table-cdc | 8.0 | 0.1 | 1.7 |
| drop-table-recreate | 128.0 | 0.1 | 2.0 |
| drop-table-polling | 105.4 | 0.1 | 1.5 |
| restart-during-snapshot | 3.1 | 0.1 | 1.5 |
| restart-during-resync | 4.5 | 0.1 | 1.6 |
| memory-pressure | 12.9 | 0.1 | 1.4 |
| reconcile-memory | 34.5 | 0.1 | 1.6 |
| drop-database | 12.0 | 0.1 | 1.8 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.4 |
| total | 396.5 | 16.6 | 46.8 |
