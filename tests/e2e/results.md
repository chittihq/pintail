...
Measured 2026-09-12T01:54:56.062Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150033 sync_runs rows for db_4f2712fe3d6f7563f86fb8940bc7eb7d |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4911 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4911 requests: p50 1ms p99 11ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 1ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 5205 vs source 5205 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_4f2712fe3d6f7563f86fb8940bc7eb7d","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-12T01:47:19.464146728+00:00","updated_at":"2026-09-12T01:53:31.944047922+00:00"},"tables":30,"rows":9118} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 83 ok, dashboards 78 ok; no errors |
| memory-pressure | memory-pressure:every failure is a designed refusal | PASS | only refusals; 0 dashboard requests failed |
| memory-pressure | memory-pressure:work still gets done | PASS | wire 240 of 240, http 83 |
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 143ms p99 667ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 19ms over 6 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 124MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 58MB before, peak 202MB during (margin 768MB) |
...
|---|---|---|---|
| snapshot | 0.0 | 0.1 | 1.5 |
| orm-compat | 2.2 | 0.0 | 1.5 |
| crud | 0.0 | 0.3 | 1.6 |
| composite-keys | 0.0 | 0.8 | 1.6 |
| type-edges | 0.0 | 0.8 | 1.6 |
| ddl | 6.2 | 3.5 | 1.4 |
| schema-drift-minimal | 0.0 | 2.6 | 1.5 |
| schema-drift-unseen | 0.0 | 1.1 | 1.4 |
| churn | 0.3 | 0.3 | 1.5 |
| contention | 14.3 | 0.1 | 1.8 |
| execution-budget | 0.0 | 0.1 | 2.0 |
| spill | 4.5 | 0.3 | 1.7 |
| pooling | 0.1 | 0.3 | 1.7 |
| local-database | 0.0 | 0.1 | 1.7 |
| restart | 0.5 | 2.6 | 2.0 |
| activity-history | 1.0 | 0.2 | 1.6 |
| poll-storm | 22.9 | 0.1 | 2.0 |
| control-plane | 31.2 | 0.1 | 1.6 |
| snapshot-ddl-window | 5.1 | 0.1 | 1.6 |
| drop-table-cdc | 8.3 | 0.1 | 2.0 |
| drop-table-recreate | 127.7 | 0.1 | 1.8 |
| drop-table-polling | 103.3 | 0.1 | 1.5 |
| restart-during-snapshot | 2.8 | 0.1 | 1.5 |
| restart-during-resync | 4.5 | 0.1 | 1.7 |
| memory-pressure | 13.1 | 0.1 | 1.4 |
| reconcile-memory | 34.9 | 0.1 | 1.6 |
| drop-database | 11.7 | 0.1 | 1.5 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.9 |
| total | 394.9 | 14.5 | 46.1 |
