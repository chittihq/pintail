...
Measured 2026-09-11T20:08:24.451Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150030 sync_runs rows for db_309a227bdbd3e6bccf303db831790f1c |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 7482 vs source 7482 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_309a227bdbd3e6bccf303db831790f1c","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-11T20:01:04.615515641+00:00","updated_at":"2026-09-11T20:07:09.720914836+00:00"},"tables":30,"rows":11395} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 101 ok, dashboards 150 ok; no errors |
| memory-pressure | memory-pressure:every failure is a designed refusal | PASS | only refusals; 0 dashboard requests failed |
| memory-pressure | memory-pressure:work still gets done | PASS | wire 240 of 240, http 101 |
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 284ms p99 1271ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 25ms over 11 samples |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 60MB before, peak 246MB during (margin 768MB) |
...
| control-plane | 31.0 | 0.1 | 0.7 |
| snapshot-ddl-window | 5.1 | 0.1 | 0.7 |
| drop-table-cdc | 10.2 | 0.1 | 1.2 |
| drop-table-recreate | 128.6 | 0.1 | 1.1 |
| drop-table-polling | 104.9 | 0.3 | 1.4 |
| restart-during-snapshot | 2.3 | 0.3 | 1.7 |
| restart-during-resync | 4.3 | 0.3 | 1.4 |
| memory-pressure | 11.0 | 0.3 | 1.8 |
| reconcile-memory | 26.6 | 0.3 | 1.4 |
| drop-database | 12.0 | 0.2 | 1.5 |
| ddl-documented-gaps | 0.0 | 0.3 | 1.3 |
| total | 387.0 | 20.5 | 31.3 |
