...
Measured 2026-09-11T09:38:42.721Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150032 sync_runs rows for db_f867b87ef8e0c62dd350b76ac00f0212 |
...
| poll-storm | poll-storm:latency stays bounded | PASS | 4926 requests: p50 1ms p99 9ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 1ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 7480 vs source 7480 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_f867b87ef8e0c62dd350b76ac00f0212","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-11T09:31:38.666143537+00:00","updated_at":"2026-09-11T09:37:45.562676018+00:00"},"tables":30,"rows":11393} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 77 ok, dashboards 89 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 164ms p99 689ms over 240 queries |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 62MB before, peak 237MB during (margin 768MB) |
...
| poll-storm | 21.3 | 0.1 | 1.4 |
| control-plane | 30.8 | 0.1 | 0.8 |
| snapshot-ddl-window | 5.1 | 0.1 | 0.8 |
| drop-table-cdc | 9.6 | 0.1 | 1.3 |
| drop-table-recreate | 128.7 | 0.1 | 1.3 |
| drop-table-polling | 103.7 | 0.1 | 0.8 |
| restart-during-snapshot | 1.6 | 0.1 | 0.8 |
| restart-during-resync | 3.6 | 0.1 | 0.8 |
| memory-pressure | 7.5 | 0.1 | 0.8 |
| reconcile-memory | 21.2 | 0.1 | 0.9 |
| drop-database | 11.6 | 0.1 | 0.8 |
| ddl-documented-gaps | 0.0 | 0.1 | 0.8 |
| total | 375.4 | 19.1 | 28.5 |
