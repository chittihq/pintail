...
Measured 2026-09-12T15:10:45.916Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150034 sync_runs rows for db_04b6a140f380c9768abaf85a21fdc0b1 |
...
| activity-history | activity-history:25 concurrent feed reads do not pile up | PASS | p50 26ms p99 29ms |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4913 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4913 requests: p50 1ms p99 9ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 1ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 5265 vs source 5265 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_04b6a140f380c9768abaf85a21fdc0b1","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-12T15:03:06.383929655+00:00","updated_at":"2026-09-12T15:09:23.743434835+00:00"},"tables":30,"rows":9178} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 67 ok, dashboards 126 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 260ms p99 1112ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 24ms over 9 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 129MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 66MB before, peak 187MB during (margin 768MB) |
...
| orm-compat | 2.1 | 0.0 | 1.6 |
| crud | 0.0 | 2.7 | 1.8 |
| composite-keys | 0.0 | 0.6 | 1.8 |
| type-edges | 0.0 | 0.8 | 1.5 |
| ddl | 5.9 | 3.7 | 1.5 |
| schema-drift-minimal | 0.0 | 2.4 | 1.2 |
| schema-drift-unseen | 0.0 | 1.4 | 1.3 |
| churn | 0.3 | 0.6 | 1.8 |
| contention | 13.9 | 0.1 | 1.7 |
| execution-budget | 0.0 | 0.1 | 1.8 |
| spill | 4.5 | 0.3 | 2.3 |
| pooling | 0.1 | 2.3 | 1.9 |
| local-database | 0.0 | 0.1 | 1.9 |
| restart | 0.5 | 2.7 | 1.7 |
| activity-history | 1.0 | 0.2 | 1.7 |
| poll-storm | 23.0 | 0.1 | 1.7 |
| control-plane | 31.2 | 0.1 | 1.7 |
| snapshot-ddl-window | 5.2 | 0.1 | 1.8 |
| drop-table-cdc | 8.1 | 0.1 | 1.8 |
| drop-table-recreate | 127.8 | 0.1 | 1.8 |
| drop-table-polling | 103.3 | 0.1 | 1.6 |
| restart-during-snapshot | 3.3 | 0.1 | 1.7 |
| restart-during-resync | 4.7 | 0.1 | 1.5 |
| memory-pressure | 13.0 | 0.1 | 1.5 |
| reconcile-memory | 32.8 | 0.1 | 1.5 |
| drop-database | 11.2 | 0.1 | 1.6 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.8 |
| total | 392.1 | 19.1 | 47.2 |
