...
Measured 2026-09-11T08:02:55.348Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150032 sync_runs rows for db_29a31ed5311858970119fb6473100aad |
...
| poll-storm | poll-storm:latency stays bounded | PASS | 4935 requests: p50 1ms p99 7ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 2ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 5181 vs source 5181 |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 108 ok, dashboards 96 ok; no errors |
| memory-pressure | memory-pressure:every failure is a designed refusal | PASS | only refusals; 0 dashboard requests failed |
| memory-pressure | memory-pressure:work still gets done | PASS | wire 240 of 240, http 108 |
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 171ms p99 948ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 14ms over 7 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 185MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 59MB before, peak 204MB during (margin 768MB) |
...
| control-plane | 31.4 | 0.1 | 1.5 |
| snapshot-ddl-window | 5.1 | 0.1 | 1.8 |
| drop-table-cdc | 10.4 | 0.1 | 1.8 |
| drop-table-recreate | 127.8 | 0.2 | 1.7 |
| drop-table-polling | 13.2 | 0.2 | 1.7 |
| restart-during-snapshot | 2.6 | 0.1 | 2.0 |
| restart-during-resync | 4.7 | 0.1 | 1.5 |
| memory-pressure | 13.1 | 0.1 | 1.8 |
| reconcile-memory | 34.4 | 0.1 | 1.5 |
| drop-database | 11.7 | 0.2 | 1.9 |
| ddl-documented-gaps | 0.0 | 0.2 | 1.8 |
| total | 307.2 | 15.0 | 47.7 |
