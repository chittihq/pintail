...
Measured 2026-09-12T20:49:54.300Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150033 sync_runs rows for db_0fa33c261e8723143f7f38d8e66e0f66 |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 5184 vs source 5184 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_0fa33c261e8723143f7f38d8e66e0f66","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-12T20:42:17.424259332+00:00","updated_at":"2026-09-12T20:48:32.892571266+00:00"},"tables":30,"rows":9097} |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 267ms p99 1085ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 25ms over 9 samples |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 74MB before, peak 185MB during (margin 768MB) |
...
| schema-drift-unseen | 0.0 | 1.4 | 1.7 |
| churn | 0.3 | 0.3 | 1.3 |
| contention | 14.3 | 0.1 | 2.1 |
...
| drop-table-recreate | 130.3 | 0.1 | 1.8 |
| drop-table-polling | 103.3 | 0.1 | 1.4 |
| restart-during-snapshot | 2.9 | 0.1 | 1.4 |
| restart-during-resync | 4.5 | 0.1 | 1.6 |
| memory-pressure | 13.8 | 0.1 | 1.6 |
| reconcile-memory | 32.6 | 0.1 | 1.7 |
| drop-database | 11.0 | 0.1 | 1.4 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.4 |
| total | 395.0 | 14.4 | 46.4 |
