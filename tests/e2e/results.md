...
Measured 2026-09-12T11:29:55.593Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150033 sync_runs rows for db_ced4c720b86847052829362bc919dfc0 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_ced4c720b86847052829362bc919dfc0","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-12T11:22:12.120064155+00:00","updated_at":"2026-09-12T11:28:31.659740787+00:00"},"tables":30,"rows":9178} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 82 ok, dashboards 132 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 261ms p99 1233ms over 240 queries |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 59MB before, peak 198MB during (margin 768MB) |
...
| crud | 0.0 | 2.4 | 1.6 |
| composite-keys | 0.0 | 0.8 | 2.0 |
| type-edges | 0.0 | 0.5 | 1.4 |
| ddl | 6.2 | 3.4 | 1.5 |
...
| drop-table-recreate | 130.1 | 0.1 | 2.0 |
| drop-table-polling | 105.4 | 0.1 | 1.5 |
| restart-during-snapshot | 3.2 | 0.1 | 1.5 |
| restart-during-resync | 4.5 | 0.1 | 1.7 |
| memory-pressure | 13.4 | 0.1 | 1.4 |
| reconcile-memory | 34.9 | 0.1 | 1.9 |
| drop-database | 11.3 | 0.1 | 1.4 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.5 |
| total | 399.6 | 16.2 | 46.5 |
