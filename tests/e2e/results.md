...
Measured 2026-09-09T12:37:28.772Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150028 sync_runs rows for db_00029f93ae65b80ec7cee9687629a919 |
...
| activity-history | activity-history:25 concurrent feed reads do not pile up | PASS | p50 28ms p99 37ms |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4922 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4922 requests: p50 1ms p99 10ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 2ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 7429 vs source 7429 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_00029f93ae65b80ec7cee9687629a919","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-09T12:30:33.913420290+00:00","updated_at":"2026-09-09T12:36:31.212589972+00:00"},"tables":21,"rows":10154} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 74 ok, dashboards 102 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 205ms p99 948ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 24ms over 7 samples |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 73MB before, peak 179MB during (margin 768MB) |
...
| poll-storm | 21.5 | 0.1 | 0.7 |
| control-plane | 32.0 | 0.1 | 0.4 |
| snapshot-ddl-window | 5.1 | 0.1 | 0.5 |
| drop-table-cdc | 7.9 | 0.1 | 0.8 |
| drop-table-recreate | 129.0 | 0.1 | 0.8 |
| drop-table-polling | 104.1 | 0.1 | 0.5 |
| restart-during-snapshot | 1.8 | 0.1 | 0.4 |
| restart-during-resync | 3.6 | 0.1 | 0.5 |
| memory-pressure | 9.8 | 0.1 | 0.4 |
| reconcile-memory | 21.1 | 0.1 | 0.5 |
| drop-database | 12.5 | 0.1 | 0.4 |
| ddl-documented-gaps | 0.0 | 0.1 | 0.4 |
| total | 379.3 | 21.3 | 13.2 |
