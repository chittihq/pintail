...
Measured 2026-09-12T22:10:22.329Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150032 sync_runs rows for db_f5191350b70a6481543272ed956b71b1 |
...
| poll-storm | poll-storm:latency stays bounded | PASS | 4923 requests: p50 1ms p99 10ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 1ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 5313 vs source 5313 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_f5191350b70a6481543272ed956b71b1","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-12T22:02:48.393285938+00:00","updated_at":"2026-09-12T22:09:00.372587825+00:00"},"tables":30,"rows":9226} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 74 ok, dashboards 138 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 266ms p99 1282ms over 240 queries |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 77MB before, peak 182MB during (margin 768MB) |
...
| orm-compat | 1.9 | 0.0 | 1.4 |
| crud | 0.0 | 0.3 | 1.6 |
| composite-keys | 0.0 | 1.1 | 1.6 |
| type-edges | 0.0 | 0.8 | 1.9 |
| ddl | 5.9 | 3.2 | 1.3 |
| schema-drift-minimal | 0.0 | 0.4 | 1.5 |
| schema-drift-unseen | 0.1 | 1.1 | 1.6 |
| churn | 0.5 | 2.6 | 1.6 |
...
| restart | 0.5 | 2.6 | 1.7 |
| activity-history | 1.0 | 0.3 | 1.8 |
| poll-storm | 22.8 | 0.1 | 1.8 |
| control-plane | 31.3 | 0.1 | 1.8 |
| snapshot-ddl-window | 5.2 | 0.1 | 1.4 |
| drop-table-cdc | 8.3 | 0.1 | 1.7 |
| drop-table-recreate | 128.1 | 0.1 | 2.0 |
| drop-table-polling | 103.1 | 0.1 | 1.7 |
| restart-during-snapshot | 3.1 | 0.1 | 1.4 |
| restart-during-resync | 4.3 | 0.1 | 1.4 |
| memory-pressure | 13.4 | 0.1 | 1.7 |
| reconcile-memory | 32.8 | 0.1 | 1.5 |
| drop-database | 11.0 | 0.1 | 1.7 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.8 |
| total | 391.9 | 14.6 | 46.3 |
