...
Measured 2026-09-13T12:35:22.949Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150030 sync_runs rows for db_09f1bc4bed94860a912afb168b01bc08 |
...
| poll-storm | poll-storm:latency stays bounded | PASS | 4909 requests: p50 1ms p99 10ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 1ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 7599 vs source 7599 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_09f1bc4bed94860a912afb168b01bc08","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-13T12:30:16.711288824+00:00","updated_at":"2026-09-13T12:34:24.235581251+00:00"},"tables":30,"rows":11512} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 109 ok, dashboards 148 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 266ms p99 1122ms over 240 queries |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 70MB before, peak 197MB during (margin 768MB) |
...
| memory-pressure | 9.7 | 0.1 | 0.7 |
| reconcile-memory | 21.0 | 0.1 | 0.7 |
| drop-database | 12.0 | 0.1 | 0.7 |
| ddl-documented-gaps | 0.0 | 0.1 | 0.6 |
| total | 260.1 | 19.7 | 25.3 |
