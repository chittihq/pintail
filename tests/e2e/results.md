...
Measured 2026-09-06T23:19:56.918Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150034 sync_runs rows for db_ea2af379f3395e4154f005c1c631e0e9 |
...
| activity-history | activity-history:25 concurrent feed reads do not pile up | PASS | p50 30ms p99 43ms |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4785 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4785 requests: p50 2ms p99 19ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 5ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 806 vs source 806 |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 74 ok, dashboards 172 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 377ms p99 1220ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 21ms over 12 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 290MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 29MB before, peak 212MB during (margin 768MB) |
...
|---|---|---|---|
| snapshot | 0.0 | 1.1 | 0.5 |
| orm-compat | 6.1 | 0.3 | 0.6 |
| crud | 0.2 | 0.7 | 0.7 |
| type-edges | 0.0 | 1.1 | 0.6 |
| ddl | 10.2 | 11.8 | 0.8 |
| schema-drift-minimal | 0.2 | 3.4 | 0.8 |
| schema-drift-unseen | 0.8 | 6.4 | 0.5 |
| churn | 10.0 | 1.9 | 0.7 |
| contention | 14.5 | 0.4 | 0.9 |
| execution-budget | 0.0 | 0.2 | 0.8 |
| spill | 2.9 | 0.4 | 0.6 |
| pooling | 0.1 | 1.2 | 0.6 |
| local-database | 0.0 | 0.1 | 0.5 |
| restart | 0.5 | 2.5 | 0.6 |
| activity-history | 1.1 | 0.3 | 1.3 |
| poll-storm | 28.1 | 0.6 | 0.8 |
| control-plane | 45.3 | 1.1 | 0.6 |
| snapshot-ddl-window | 6.6 | 0.8 | 0.6 |
| drop-table-cdc | 11.9 | 0.4 | 0.4 |
| drop-table-recreate | 129.4 | 0.6 | 0.4 |
| drop-table-polling | 23.8 | 0.9 | 0.8 |
| restart-during-snapshot | 5.9 | 1.4 | 0.8 |
| restart-during-resync | 7.8 | 1.1 | 0.5 |
| memory-pressure | 14.7 | 1.1 | 0.6 |
| reconcile-memory | 46.3 | 0.9 | 0.7 |
| drop-database | 14.2 | 1.4 | 0.4 |
| ddl-documented-gaps | 0.0 | 0.9 | 0.7 |
| total | 380.6 | 43.0 | 17.8 |
