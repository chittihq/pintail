...
Measured 2026-09-11T13:35:05.081Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150033 sync_runs rows for db_56db0d43693f0850581a2cbd5eb8fd58 |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 5316 vs source 5316 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_56db0d43693f0850581a2cbd5eb8fd58","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-11T13:27:26.231212706+00:00","updated_at":"2026-09-11T13:33:40.610274193+00:00"},"tables":30,"rows":9229} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 87 ok, dashboards 90 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 185ms p99 871ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 19ms over 7 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 193MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 59MB before, peak 195MB during (margin 768MB) |
...
| drop-table-cdc | 8.2 | 0.1 | 1.7 |
| drop-table-recreate | 128.0 | 0.1 | 1.7 |
| drop-table-polling | 103.4 | 0.1 | 1.5 |
| restart-during-snapshot | 3.1 | 0.1 | 1.9 |
| restart-during-resync | 4.3 | 0.1 | 1.6 |
| memory-pressure | 12.8 | 0.1 | 1.8 |
| reconcile-memory | 34.4 | 0.1 | 1.6 |
| drop-database | 11.7 | 0.1 | 1.8 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.8 |
| total | 393.8 | 16.3 | 47.6 |
