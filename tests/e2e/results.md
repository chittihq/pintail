...
Measured 2026-09-07T12:14:51.714Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150030 sync_runs rows for db_9efb022f1cc136f2df437411a32459d1 |
...
| activity-history | activity-history:25 concurrent feed reads do not pile up | PASS | p50 33ms p99 42ms |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4886 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4886 requests: p50 1ms p99 15ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 1ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 7404 vs source 7404 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"id":"db_9efb022f1cc136f2df437411a32459d1","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-07T12:07:55.821966370+00:00","updated_at":"2026-09-07T12:13:57.310048903+00:00"},"tables":21,"rows":10129} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 76 ok, dashboards 170 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 311ms p99 1401ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 13ms over 12 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 288MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 53MB before, peak 222MB during (margin 768MB) |
...
| orm-compat | 5.6 | 0.2 | 0.6 |
| crud | 0.0 | 1.4 | 1.2 |
| composite-keys | 0.0 | 1.2 | 0.3 |
| type-edges | 0.0 | 2.1 | 0.2 |
| ddl | 7.4 | 2.9 | 0.1 |
| schema-drift-minimal | 0.0 | 2.1 | 0.1 |
| schema-drift-unseen | 0.0 | 2.3 | 0.1 |
| churn | 0.2 | 2.1 | 0.1 |
| contention | 14.0 | 0.1 | 0.7 |
...
| restart-during-snapshot | 1.6 | 0.1 | 0.4 |
| restart-during-resync | 3.6 | 0.1 | 0.4 |
| memory-pressure | 9.6 | 0.1 | 0.4 |
| reconcile-memory | 20.8 | 0.1 | 0.4 |
| drop-database | 10.3 | 0.1 | 0.4 |
| ddl-documented-gaps | 0.0 | 0.1 | 0.4 |
| total | 380.1 | 20.7 | 14.0 |
