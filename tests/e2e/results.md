...
Measured 2026-09-10T10:15:40.631Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150031 sync_runs rows for db_018d02f0065ac7dd9f08420664f106af |
...
| activity-history | activity-history:25 concurrent feed reads do not pile up | PASS | p50 52ms p99 166ms |
...
| poll-storm | poll-storm:latency stays bounded | PASS | 4903 requests: p50 1ms p99 15ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 1ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 7425 vs source 7425 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_018d02f0065ac7dd9f08420664f106af","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-10T10:08:31.411239044+00:00","updated_at":"2026-09-10T10:14:40.762750439+00:00"},"tables":30,"rows":11338} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 76 ok, dashboards 114 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 217ms p99 1001ms over 240 queries |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 60MB before, peak 213MB during (margin 768MB) |
...
| orm-compat | 4.0 | 0.0 | 0.8 |
| crud | 0.0 | 0.3 | 0.9 |
| composite-keys | 0.0 | 1.4 | 0.9 |
| type-edges | 0.0 | 1.8 | 0.9 |
| ddl | 6.6 | 2.7 | 0.9 |
| schema-drift-minimal | 0.0 | 1.4 | 0.9 |
