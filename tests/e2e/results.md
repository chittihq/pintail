...
Measured 2026-09-12T18:28:26.003Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150033 sync_runs rows for db_4b84226e9195185f764ef3f32c489005 |
...
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 5222 vs source 5222 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_4b84226e9195185f764ef3f32c489005","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-12T18:20:49.468922787+00:00","updated_at":"2026-09-12T18:27:04.313057501+00:00"},"tables":30,"rows":9135} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 106 ok, dashboards 144 ok; no errors |
| memory-pressure | memory-pressure:every failure is a designed refusal | PASS | only refusals; 0 dashboard requests failed |
| memory-pressure | memory-pressure:work still gets done | PASS | wire 240 of 240, http 106 |
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 271ms p99 1124ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 17ms over 10 samples |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 72MB before, peak 182MB during (margin 768MB) |
...
| orm-compat | 2.1 | 0.0 | 1.7 |
| crud | 0.0 | 2.4 | 1.6 |
| composite-keys | 0.0 | 1.1 | 1.5 |
| type-edges | 0.0 | 0.8 | 1.8 |
| ddl | 6.0 | 3.5 | 1.6 |
| schema-drift-minimal | 0.0 | 2.4 | 1.3 |
| schema-drift-unseen | 0.0 | 1.4 | 1.3 |
| churn | 0.4 | 0.6 | 1.5 |
| contention | 13.8 | 0.1 | 1.8 |
| execution-budget | 0.0 | 0.1 | 1.7 |
| spill | 4.7 | 0.3 | 1.8 |
| pooling | 0.1 | 0.3 | 2.0 |
| local-database | 0.0 | 0.1 | 1.9 |
| restart | 0.5 | 2.4 | 1.9 |
| activity-history | 1.0 | 0.3 | 1.7 |
| poll-storm | 23.0 | 0.1 | 1.8 |
| control-plane | 31.2 | 0.1 | 1.6 |
| snapshot-ddl-window | 5.2 | 0.1 | 1.6 |
| drop-table-cdc | 8.4 | 0.1 | 1.6 |
| drop-table-recreate | 128.0 | 0.1 | 1.7 |
| drop-table-polling | 103.5 | 0.1 | 1.6 |
| restart-during-snapshot | 2.8 | 0.2 | 1.6 |
| restart-during-resync | 4.5 | 0.1 | 1.5 |
| memory-pressure | 13.2 | 0.1 | 1.6 |
| reconcile-memory | 32.7 | 0.1 | 1.5 |
| drop-database | 11.3 | 0.1 | 1.6 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.7 |
| total | 392.3 | 17.0 | 46.1 |
