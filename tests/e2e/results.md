...
Measured 2026-09-11T00:00:26.154Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150032 sync_runs rows for db_5b7ffbb522809f5a46f7e3b7763892e5 |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4920 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4920 requests: p50 1ms p99 11ms |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_5b7ffbb522809f5a46f7e3b7763892e5","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-10T23:53:17.656703311+00:00","updated_at":"2026-09-10T23:59:26.462034647+00:00"},"tables":30,"rows":11437} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 77 ok, dashboards 84 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 161ms p99 788ms over 240 queries |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 62MB before, peak 235MB during (margin 768MB) |
...
| drop-table-polling | 103.4 | 0.1 | 0.9 |
