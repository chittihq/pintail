...
Measured 2026-09-13T13:24:46.690Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150033 sync_runs rows for db_296e9ae39d8be882fb4701b3b9d314ea |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 100 ok, dashboards 132 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 255ms p99 1066ms over 240 queries |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 61MB before, peak 200MB during (margin 768MB) |
...
| poll-storm | 22.7 | 0.1 | 1.9 |
| control-plane | 31.2 | 0.1 | 1.5 |
| snapshot-ddl-window | 5.2 | 0.1 | 1.4 |
| drop-table-cdc | 8.4 | 0.1 | 1.7 |
| drop-table-recreate | 10.5 | 0.1 | 2.1 |
| drop-table-polling | 13.0 | 0.1 | 1.5 |
| restart-during-snapshot | 2.6 | 0.1 | 1.5 |
| restart-during-resync | 4.5 | 0.1 | 1.5 |
| memory-pressure | 12.9 | 0.1 | 1.6 |
| reconcile-memory | 35.2 | 0.1 | 1.7 |
| drop-database | 11.0 | 0.1 | 1.4 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.6 |
| total | 186.2 | 16.4 | 46.6 |
