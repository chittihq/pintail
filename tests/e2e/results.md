...
Measured 2026-09-13T11:05:21.605Z.
...
| activity-history | activity-history:the history is in the control plane pintail reads | PASS | 150033 sync_runs rows for db_5fd5faf73458e483293fd7e419b12858 |
...
| poll-storm | poll-storm:no request fails under 25 open dashboards | PASS | 0 failed of 4905 |
| poll-storm | poll-storm:latency stays bounded | PASS | 4905 requests: p50 1ms p99 10ms |
| poll-storm | poll-storm:health never stalls | PASS | health p99 2ms |
| poll-storm | poll-storm:replication keeps pace under the storm | PASS | orders replica 5223 vs source 5223 |
...
| drop-table-polling | polling:one dropped table does not stop the other tables | WARN | the whole poll cycle aborts on the first table that fails, so every other table stops replicating too: {"database":{"restored_backup_created_at":null,"data_age_seconds":null,"id":"db_5fd5faf73458e483293fd7e419b12858","name":"e2e_db","mode":"polling","effective_mode":"polling","state":"error","include_tables":[],"exclude_tables":[],"poll_interval_seconds":5,"reconcile_interval_seconds":600,"keyless_policy":"quarantine","created_at":"2026-09-13T10:57:47.214541213+00:00","updated_at":"2026-09-13T11:03:59.801673924+00:00"},"tables":30,"rows":9136} |
...
| memory-pressure | memory-pressure:the process survives the storm | PASS | wire 240 ok, http 85 ok, dashboards 132 ok; no errors |
...
| memory-pressure | memory-pressure:wire queries are not starved by the HTTP surface | PASS | wire p50 275ms p99 1416ms over 240 queries |
| memory-pressure | memory-pressure:health never stalls | PASS | health p99 13ms over 9 samples |
| memory-pressure | memory-pressure:the process stays inside its ceiling | PASS | peak RSS 132MB with a 256MB budget |
...
| reconcile-memory | reconcile-memory:reconciliation is bounded in memory | PASS | RSS 75MB before, peak 176MB during (margin 768MB) |
...
|---|---|---|---|
| snapshot | 0.0 | 0.1 | 1.6 |
| orm-compat | 2.0 | 0.0 | 1.6 |
| crud | 0.0 | 0.3 | 1.4 |
| composite-keys | 0.0 | 0.8 | 1.5 |
| type-edges | 0.0 | 1.1 | 1.8 |
| ddl | 5.9 | 3.4 | 1.3 |
| schema-drift-minimal | 0.0 | 2.6 | 1.3 |
| schema-drift-unseen | 0.0 | 1.4 | 1.6 |
| churn | 0.3 | 0.3 | 1.7 |
| contention | 13.8 | 0.1 | 1.9 |
| execution-budget | 0.0 | 0.1 | 1.8 |
| spill | 4.6 | 0.3 | 1.8 |
| pooling | 0.1 | 0.3 | 1.9 |
| local-database | 0.0 | 0.1 | 1.8 |
| restart | 0.5 | 2.6 | 2.0 |
| activity-history | 1.0 | 0.2 | 1.6 |
| poll-storm | 23.0 | 0.1 | 1.8 |
| control-plane | 31.3 | 0.1 | 1.5 |
| snapshot-ddl-window | 5.2 | 0.1 | 1.8 |
| drop-table-cdc | 8.1 | 0.1 | 1.7 |
| drop-table-recreate | 128.0 | 0.1 | 2.0 |
| drop-table-polling | 103.2 | 0.1 | 1.7 |
| restart-during-snapshot | 3.1 | 0.1 | 1.6 |
| restart-during-resync | 4.5 | 0.1 | 1.4 |
| memory-pressure | 12.9 | 0.1 | 1.9 |
| reconcile-memory | 32.4 | 0.1 | 1.6 |
| drop-database | 11.3 | 0.1 | 1.7 |
| ddl-documented-gaps | 0.0 | 0.1 | 1.7 |
| total | 391.1 | 15.0 | 47.1 |
