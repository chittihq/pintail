...
| Spill | Sort, grouped aggregation and hash-join build sides spill into query-isolated directories; grace joins re-partition up to 3 times; per-query/global disk quotas, Prometheus counters and EXPLAIN ANALYZE counters are enforced |
