...
export const CLASSES: BugClass[] = [
  ...
  },
  {
    ...
    gates: ['cdc-integration', 'e2e', 'fuzz-binlog'],
    relevance: 'core',
    rules: {
  ...
  },
  {
    ...
    gates: ['cdc-integration', 'e2e', 'recovery'],
    relevance: 'core',
    rules: {
  ...
  },
  {
    ...
    gates: ['crash-fuzz', 'recovery-sequences', 'recovery'],
    relevance: 'core',
    rules: {
