...
| Filtered count | 587 ms | 32 ms | 30 ms |
| Group by status | 35,782 ms | 13 ms | 64 ms |
| Region × status breakdown | 13,290 ms | 12 ms | 275 ms |
| Monthly revenue (2023) | 5,562 ms | 13 ms | 44 ms |
| Top 10 spenders | 810,282 ms | 91 ms | 286 ms |
| Regional analytics | 57,104 ms | 12 ms | 169 ms |
| Join users + orders | 834,387 ms | 13 ms | 207 ms |
...
|---|---:|---:|---:|---:|
| Filtered count, novel constant | 1,130 ms | 410 ms | 59 ms | 0.14× |
| Group by region (novel group column) | 14,081 ms | 869 ms | 171 ms | 0.20× |
| Monthly revenue, novel year | 9,202 ms | 133 ms | 44 ms | 0.33× |
| Regional analytics, novel range | 57,980 ms | 526 ms | 180 ms | 0.34× |
...
<sub>Generated from `benchmark/results.json` (2026-08-18T17:58:29.922Z) by
