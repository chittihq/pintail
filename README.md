...
|---|---:|---:|---:|
| Full table count | 1,563 ms | 13 ms | 13 ms |
| Filtered count | 587 ms | 13 ms | 32 ms |
| Group by status | 35,782 ms | 16 ms | 69 ms |
| Region × status breakdown | 13,290 ms | 12 ms | 269 ms |
| Monthly revenue (2023) | 5,562 ms | 38 ms | 46 ms |
| Top 10 spenders | 810,282 ms | 96 ms | 254 ms |
| Regional analytics | 57,104 ms | 15 ms | 171 ms |
| Join users + orders | 834,387 ms | 15 ms | 201 ms |
...
|---|---:|---:|---:|---:|
| Filtered count, novel constant | 1,130 ms | 413 ms | 51 ms | 0.12× |
| Group by region (novel group column) | 14,081 ms | 833 ms | 94 ms | 0.11× |
| Monthly revenue, novel year | 9,202 ms | 137 ms | 53 ms | 0.39× |
| Regional analytics, novel range | 57,980 ms | 471 ms | 178 ms | 0.38× |
...
<sub>Generated from `benchmark/results.json` (2026-08-18T15:17:44.006Z) by
