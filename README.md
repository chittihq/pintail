...
|---|---:|---:|---:|
| Full table count | 1,563 ms | 13 ms | 15 ms |
| Filtered count | 587 ms | 13 ms | 31 ms |
| Group by status | 35,782 ms | 13 ms | 68 ms |
| Region × status breakdown | 13,290 ms | 14 ms | 252 ms |
| Monthly revenue (2023) | 5,562 ms | 15 ms | 48 ms |
| Top 10 spenders | 810,282 ms | 91 ms | 254 ms |
| Regional analytics | 57,104 ms | 13 ms | 172 ms |
| Join users + orders | 834,387 ms | 14 ms | 202 ms |
...
|---|---:|---:|---:|---:|
| Filtered count, novel constant | 1,130 ms | 411 ms | 55 ms | 0.13× |
| Group by region (novel group column) | 14,081 ms | 970 ms | 102 ms | 0.11× |
| Monthly revenue, novel year | 9,202 ms | 136 ms | 51 ms | 0.38× |
| Regional analytics, novel range | 57,980 ms | 524 ms | 181 ms | 0.35× |
...
<sub>Generated from `benchmark/results.json` (2026-08-18T04:38:29.223Z) by
